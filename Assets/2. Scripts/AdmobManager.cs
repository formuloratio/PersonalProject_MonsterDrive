...
public class AdmobManager : MonoBehaviour
{
	...
	public void LoadFrontAd()
	{
		...
		// string frontIdTest = "ca-app-pub-7001944512056892/3699407861"; //찐
#elif UNITY_IPHONE || UNITY_IOS
		...
		InterstitialAd.Load(finalFrontId, new AdRequest(), (InterstitialAd ad, LoadAdError loadError) =>
        {
            ...
            frontAd.OnAdFullScreenContentClosed += () =>
            {
                if (isDetailLog)
                {
                    Debug.Log("Front Ad has been closed.");
                }
                
                // 광고가 닫히면 원하는 씬을 로드합니다.
	...
	public void LoadRewardAd()
	{
		...
		// string rewardIdTest = "ca-app-pub-7001944512056892/1073244525"; //찐
#elif UNITY_IPHONE || UNITY_IOS
